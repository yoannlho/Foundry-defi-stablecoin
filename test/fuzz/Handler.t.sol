...
contract Handler is Test {
    ...
    // This break our invariant test suite (Good for testing in audit : If the price of the collateral drop to quickly, the test must be fail)
    /* function updateCollateralPrice(uint96 newPrice) public {
        int256 newPriceInt = int256(uint256(newPrice));
        ethUsdPriceFeed.updateAnswer(newPriceInt);
        console.log("ethUsdPriceFeed: %s", address(ethUsdPriceFeed));
    }
    */
    // Helper Functions
