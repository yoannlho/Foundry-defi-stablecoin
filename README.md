...
```
git clone https://github.com/yoannlho/Foundry-defi-stablecoin
...
- The latest version of openzeppelin-contracts has changes in the ERC20Mock file. The code has been adjusted to fit with the lattest version of openzeppelin contracts `forge install openzeppelin/openzeppelin-contracts --no-commit`
...
You can use slither to do a quick review of the code in case you want to verify that this contract does not contain some vulnerability
